...
class NMSFreeCoder(BaseBBoxCoder):
    ...
    def decode_single(self, cls_scores, bbox_preds):
        ...
        # 打印 self.pc_range 的类型和值
        print(f"Type of self.pc_range: {type(self.pc_range)}")
        print(f"Value of self.pc_range: {self.pc_range}")
        final_scores = scores
        final_preds = labels
        ...
        # 打印 self.pc_range 的类型和值
        print(f"Type of self.post_center_range: {type(self.post_center_range)}")
        print(f"Value of self.post_center_range: {self.post_center_range}")
